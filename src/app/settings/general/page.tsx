...
export default function GeneralSettings() {
  ...
  const [openDest, setOpenDest] = useState<"terminal" | "editor" | "finder">(
    "terminal"
  );
  const [language, setLanguage] = useState<"auto" | "en" | "es" | "fr" | "de">(
    "auto"
  );
  const [terminalLoc, setTerminalLoc] = useState<"bottom" | "right">("bottom");
      ...
      <SettingsSection title="Application">
        <SettingsCard>
          ...
          <SettingsRow
            ...
            control={<Switch checked={menuBar} onChange={setMenuBar} label="Show in menu bar" />}
          />
          <SettingsRow
